            ...
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <DropdownMenu modal={false}>
                        <DropdownMenuPrimitive.Trigger className={cn(buttonVariants({ variant: "ghost" }), "relative h-12 w-12 rounded-2xl hover:bg-transparent p-0 transition-transform active:scale-95 cursor-pointer outline-none focus:outline-none")}>
                            <Avatar className="h-12 w-12 border-2 border-white shadow-md pointer-events-none">
                                <AvatarFallback className="bg-primary text-white font-black text-xs">
                                    {user.name ? user.name.charAt(0).toUpperCase() : 'T'}
                                </AvatarFallback>
                            </Avatar>
                        </DropdownMenuPrimitive.Trigger>
                        <DropdownMenuContent className="w-64 rounded-2xl p-2 shadow-2xl border-gray-100" align="end">
